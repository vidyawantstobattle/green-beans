    ...
    <div className="join-discord-container">
      <div className="join-discord-content">
        ...
        <div className="discord-description">
          ...
          <p>We are passionate about connecting with our community. Join us on Discord to discuss impactOS, ask questions, and share your feedback.</p>
          <h3>Key Takeaways</h3>
          <ul>
          ...
          <p>We look forward to seeing you there and hearing your thoughts on how we can improve our solutions. Your feedback is invaluable to us!</p>
        </div>
      </div>
    </div>
  );
